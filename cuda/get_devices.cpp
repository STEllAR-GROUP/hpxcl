...
static hpx::lcos::future<std::vector<hpx::cuda::device>> get_devices_on_nodes(
	...
	for (auto &locality : localities) {
		...
		hpx::lcos::future<std::vector<hpx::cuda::device>> locality_device_future =
	...
	hpx::lcos::future
			< std::vector<hpx::lcos::future<std::vector<hpx::cuda::device> > >
			> combined_locality_device_future = hpx::when_all(
			locality_device_futures);

	// create result future
	hpx::lcos::future<std::vector<hpx::cuda::device>> result_future =
			combined_locality_device_future.then(
					hpx::util::bind(
...
hpx::lcos::future<std::vector<hpx::cuda::device>> hpx::cuda::get_devices(
...
hpx::lcos::future<std::vector<hpx::cuda::device>> hpx::cuda::get_local_devices(
		int major, int minor) {
...
hpx::lcos::future<std::vector<hpx::cuda::device>> hpx::cuda::get_remote_devices(
		int major, int minor) {
...
hpx::lcos::future<std::vector<hpx::cuda::device>> hpx::cuda::get_all_devices(
		int major, int minor) {
