...
class HPX_CUDA_EXPORT program
 ...
 public:
  ...
  void run(std::vector<hpx::naming::id_type> args, std::string modulename,
           ...
           std::vector<hpx::naming::id_type> dependencies, size_t shared_memory,
           int stream = -1);
...
HPX_DECLARE_ACTION(hpx::cuda::server::program::build_action,
...
HPX_REGISTER_ACTION_DECLARATION(
    hpx::cuda::server::program::get_streams_size_action,
