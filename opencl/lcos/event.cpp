...
void hpx::opencl::lcos::detail::unregister_event(
    hpx::naming::id_type device_id, hpx::naming::gid_type event_gid) {
...
// template<>
void hpx::opencl::lcos::detail::event_data<void,
                                           hpx::util::unused_type>::arm() {
