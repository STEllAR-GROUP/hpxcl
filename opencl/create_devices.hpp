 ...
 * <A
 * HREF="http://www.khronos.org/registry/cl/sdk/1.2/docs/man/xhtml/clGetDeviceIDs.html">OpenCL
 * Reference</A>.
 ...
 */
HPX_OPENCL_EXPORT
hpx::lcos::future<std::vector<device>> create_devices(
 ...
 */
HPX_OPENCL_EXPORT
hpx::lcos::future<std::vector<device>> create_all_devices(
    cl_device_type device_type, std::string required_cl_version);
 ...
 */
HPX_OPENCL_EXPORT
hpx::lcos::future<std::vector<device>> create_local_devices(
    cl_device_type device_type, std::string required_cl_version);
 ...
 */
HPX_OPENCL_EXPORT
hpx::lcos::future<std::vector<device>> create_remote_devices(
    cl_device_type device_type, std::string required_cl_version);
