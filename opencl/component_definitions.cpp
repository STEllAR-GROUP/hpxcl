...
HPX_REGISTER_MINIMAL_COMPONENT_FACTORY(buffer_component_type,
                                       hpx_opencl_buffer);
...
HPX_REGISTER_MINIMAL_COMPONENT_FACTORY(program_component_type,
                                       hpx_opencl_program);
...
HPX_REGISTER_MINIMAL_COMPONENT_FACTORY(kernel_component_type,
                                       hpx_opencl_kernel);
