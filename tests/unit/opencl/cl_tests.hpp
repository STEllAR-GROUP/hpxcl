...
static void print_testdevice_info(hpx::opencl::device& cldevice,
  ...
  // Write Info Code
  hpx::cout << "Device ID:  " << device_id << " / " << num_devices << hpx::endl;
  hpx::cout << "Device GID: " << cldevice.get_id() << hpx::endl;
  hpx::cout << "Version:    " << version << hpx::endl;
  hpx::cout << "Name:       "
            << cldevice.get_device_info<CL_DEVICE_NAME>().get() << hpx::endl;
  hpx::cout << "Vendor:     "
            << cldevice.get_device_info<CL_DEVICE_VENDOR>().get() << hpx::endl;
  hpx::cout << "Profile:    "
            << cldevice.get_device_info<CL_DEVICE_PROFILE>().get() << hpx::endl;
