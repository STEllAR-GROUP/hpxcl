...
CREATE_BUFFER(invalid_program_src,
              "                                                                "
              "          \n"
              "   __kernel void hello_world(__global char * in, __global char "
              "* out)     \n"
              "   {                                                            "
              "          \n"
...
const char initdata_arr[] = {
    ('H' - static_cast<char>(0)),  ('e' - static_cast<char>(1)),
    ('l' - static_cast<char>(2)),  ('l' - static_cast<char>(3)),
    ('o' - static_cast<char>(4)),  (',' - static_cast<char>(5)),
    (' ' - static_cast<char>(6)),  ('W' - static_cast<char>(7)),
    ('o' - static_cast<char>(8)),  ('r' - static_cast<char>(9)),
    ('l' - static_cast<char>(10)), ('d' - static_cast<char>(11)),
    ('!' - static_cast<char>(12)), ('\0' - static_cast<char>(13))};
const char refdata2_arr[] = {
    ('H' + static_cast<char>(0)),  ('e' + static_cast<char>(1)),
    ('l' + static_cast<char>(2)),  ('l' + static_cast<char>(3)),
    ('o' + static_cast<char>(4)),  (',' + static_cast<char>(5)),
    (' ' + static_cast<char>(6)),  ('W' + static_cast<char>(7)),
...
hpx::opencl::program remotely_create_program(hpx::opencl::device device) {
  return device.create_program_with_source(program_src);
}

hpx::opencl::kernel remotely_create_kernel(hpx::opencl::program program) {
  return program.create_kernel("hello_world");
}

hpx::opencl::buffer remotely_create_buffer(hpx::opencl::device device) {
