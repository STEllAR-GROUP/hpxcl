 ...
 public:
  ...
  T *exchange(T *replacement,
    ...
    return static_cast<T *>(
        super::exchange(static_cast<void *>(replacement), order));
  }
  using super::is_lock_free;
...
&&defined(BOOST_ATOMIC_HAVE_SSE2) typedef atomic<__m128i> atomic_uint128_t;
