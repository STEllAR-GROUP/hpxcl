...
namespace detail {
namespace atomic {
static inline int32_t fenced_compare_exchange_strong_32(volatile int32_t *ptr,
                                                        int32_t expected,
                                                        int32_t desired) {
...
static inline int64_t fenced_compare_exchange_strong_64(int64_t *ptr,
                                                        int64_t expected,
                                                        int64_t desired) {
...
namespace detail {
namespace atomic {
static inline int32_t fenced_compare_exchange_strong(int32_t *ptr,
                                                     int32_t expected,
                                                     int32_t desired) {
...
#define BOOST_ATOMIC_HAVE_CAS32 1
#if defined(_WIN64)
static inline int64_t fenced_compare_exchange_strong(int64_t *ptr,
                                                     int64_t expected,
                                                     int64_t desired) {
...
namespace detail {
namespace atomic {
static inline int32_t fenced_compare_exchange_strong_32(int32_t *ptr,
                                                        int32_t expected,
                                                        int32_t desired) {
...
class atomic_generic_cas32 {
 ...
 public:
  ...
  T load(memory_order order = memory_order_seq_cst) const volatile {
    T expected = (T)i;
    do {
    } while (!const_cast<this_type *>(this)->compare_exchange_weak(
        expected, expected, order, memory_order_relaxed));
    return expected;
  }
  ...
  bool compare_exchange_strong(T &expected, T desired,
    ...
    T found;
    found = (T)fenced_compare_exchange_strong_32(&i, (int32_t)expected,
                                                 (int32_t)desired);
  ...
  T exchange(T r, memory_order order = memory_order_seq_cst) volatile {
    T expected = (T)i;
    do {
    } while (!compare_exchange_weak(expected, r, order, memory_order_relaxed));
    return expected;
  }
