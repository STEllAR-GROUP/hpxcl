...
class BOOST_LOCKFREE_DCAS_ALIGNMENT tagged_ptr {
 public:
  ...
  bool operator!=(volatile tagged_ptr const& p) const { return !operator==(p); }
  /* @} */

  /** pointer access */
  /* @{ */
  T* get_ptr(void) const { return ptr; }

  void set_ptr(T* p) { ptr = p; }
  /* @} */
  ...
  operator bool(void) const { return ptr != 0; }
  /* @} */
