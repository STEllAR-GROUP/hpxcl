...
int main(int argc, char* argv[]) {
	...
	data_futures.push_back(inbuffer_1.enqueue_write(0, sizeof(int) * SIZE, input_1));

	program prog_1 = cudaDevice_1.create_program_with_file("p2p_test_kernel.cu").get();
	...
	program prog_2 = cudaDevice_2.create_program_with_file("p2p_test_kernel.cu").get();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	data_futures.push_back(outbuffer_1.enqueue_write(0, sizeof(int) * SIZE, output_1));
	...
	auto f = outbuffer_1.p2p_copy(inbuffer_2.get_device_pointer().get(), inbuffer_2.get_device_id().get(), sizeof(int) * SIZE);
	...
	data_futures.push_back(outbuffer_2.enqueue_write(0, sizeof(int) * SIZE, output_2));
