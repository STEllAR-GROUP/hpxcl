...
workload::workload(size_t num_pixels_x_, size_t num_pixels_y_,
                   double topleft_x_, double topleft_y_, double hor_pixdist_x_,
                   double hor_pixdist_y_, double vert_pixdist_x_,
                   double vert_pixdist_y_, size_t img_id_, size_t pos_in_img_x_,
                   size_t pos_in_img_y_, size_t line_offset_)
