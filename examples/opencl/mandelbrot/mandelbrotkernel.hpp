...
"        double startx = position[0];                                        \n"
"        double starty = position[1];                                        \n"
"        double hori_vector_x = position[2];                                 \n"
"        double hori_vector_y = position[3];                                 \n"
"        double vert_vector_x = position[4];                                 \n"
"        double vert_vector_y = position[5];                                 \n"
"                                                                            \n"
"        // calculate center position                                        \n"
"        double poscenterx = startx                                          \n"
"                            + (hori_vector_x * tid_x) / (size_x - 1)        \n"
"                            + (vert_vector_x * tid_y) / (size_y - 1);       \n"
"        double poscentery = starty                                          \n"
"                            + (hori_vector_y * tid_x) / (size_x - 1)        \n"
"                            + (vert_vector_y * tid_y) / (size_y - 1);       \n"
"                                                                            \n"
"        // calculate horizontal pixel distance                              \n"
"        double hori_pixdist_x = hori_vector_x / (size_x - 1.0);             \n"
"        double hori_pixdist_y = hori_vector_y / (size_x - 1.0);             \n"
"                                                                            \n"
"        // calculate vertical pixel distance                                \n"
"        double vert_pixdist_x = vert_vector_x / (size_y - 1.0);             \n"
"        double vert_pixdist_y = vert_vector_y / (size_y - 1.0);             \n"
"                                                                            \n"
"        // calculate local position                                         \n"
"        double local_pos_x = (worker_id_x - 3.5) / 8.0;                     \n"
"        double local_pos_y = (worker_id_y - 3.5) / 8.0;                     \n"
"                                                                            \n"
...
"            out[3*tid_x + 0] = (unsigned char)(sum_r/64.0);\n"
"            out[3*tid_x + 1] = (unsigned char)(sum_g/64.0);\n"
"            out[3*tid_x + 2] = (unsigned char)(sum_b/64.0);\n"
"                                                                            \n"
"        }                                                                   \n"
"                                                                            \n"
"    }                                                                       \n"
