...
static buffer_type smvp_src( smvp_src_str,
                                    sizeof(smvp_src_str),
...
int main(int argc, char* argv[])
{
	...
	//creating buffers
	buffer ADataBuffer = cldevice.create_buffer(CL_MEM_READ_ONLY, (*count)*sizeof( int ));
	buffer AIndexBuffer = cldevice.create_buffer(CL_MEM_READ_ONLY, (*count)*sizeof( int ));
    ...
    set_arg_futures.push_back(dgemm_kernel.set_arg_async(0, ADataBuffer));
    set_arg_futures.push_back(dgemm_kernel.set_arg_async(1, AIndexBuffer));
    set_arg_futures.push_back(dgemm_kernel.set_arg_async(2, APointerBuffer));
    set_arg_futures.push_back(dgemm_kernel.set_arg_async(3, BBuffer));
    set_arg_futures.push_back(dgemm_kernel.set_arg_async(4, CBuffer));
    set_arg_futures.push_back(dgemm_kernel.set_arg_async(5, mBuffer));
    set_arg_futures.push_back(dgemm_kernel.set_arg_async(6, nBuffer));
    set_arg_futures.push_back(dgemm_kernel.set_arg_async(7, countBuffer));
    set_arg_futures.push_back(dgemm_kernel.set_arg_async(8, alphaBuffer));
