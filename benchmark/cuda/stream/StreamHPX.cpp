...
///////////////////////////////////////////////////////////////////////////////
double mysecond() { return hpx::util::high_resolution_clock::now() * 1e-9; }
...
///////////////////////////////////////////////////////////////////////////////
void check_results(size_t iterations, size_t size, double* a, double* b,
                   double* c) {
...
///////////////////////////////////////////////////////////////////////////////
std::vector<std::vector<double>> run_benchmark(size_t iterations, size_t size) {
  ...
  hpx::lcos::future<hpx::cuda::buffer> faBuffer =
      cudaDevice.create_buffer(size * sizeof(double));
  hpx::lcos::future<hpx::cuda::buffer> fbBuffer =
      cudaDevice.create_buffer(size * sizeof(double));
  hpx::lcos::future<hpx::cuda::buffer> fcBuffer =
      cudaDevice.create_buffer(size * sizeof(double));
  hpx::lcos::future<hpx::cuda::buffer> fsizeBuffer =
      cudaDevice.create_buffer(sizeof(size_t));
  hpx::lcos::future<hpx::cuda::buffer> ffBuffer =
...
int main(int argc, char* argv[]) {
  ...
  std::cout
      ...
      << "Memory per array = " << sizeof(double) * (size / 1024. / 1024.)
      << " MiB "
      << "(= " << sizeof(double) * (size / 1024. / 1024. / 1024.) << " GiB).\n"
      << "-------------------------------------------------------------\n"
  ...
  const double bytes[4] = {
      (double)(2 * sizeof(double) * size), (double)(2 * sizeof(double) * size),
      (double)(3 * sizeof(double) * size), (double)(3 * sizeof(double) * size)};
