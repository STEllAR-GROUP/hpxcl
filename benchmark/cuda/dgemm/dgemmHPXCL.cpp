...
int main(int argc, char* argv[]) {
  ...
  hpx::lcos::future<program> fProg =
      cudaDevice.create_program_with_file("dgemm.cu");
  ...
  hpx::lcos::future<hpx::cuda::buffer> fABuffer =
      cudaDevice.create_buffer(m * k * sizeof(double));
  hpx::lcos::future<hpx::cuda::buffer> fBBuffer =
      cudaDevice.create_buffer(n * k * sizeof(double));
  hpx::lcos::future<hpx::cuda::buffer> fCBuffer =
      cudaDevice.create_buffer(m * n * sizeof(double));
  hpx::lcos::future<hpx::cuda::buffer> falphaBuffer =
      cudaDevice.create_buffer(sizeof(double));
  hpx::lcos::future<hpx::cuda::buffer> fbetaBuffer =
      cudaDevice.create_buffer(sizeof(double));
  hpx::lcos::future<hpx::cuda::buffer> fmBuffer =
      cudaDevice.create_buffer(sizeof(int));
  hpx::lcos::future<hpx::cuda::buffer> fnBuffer =
      cudaDevice.create_buffer(sizeof(int));
  hpx::lcos::future<hpx::cuda::buffer> fkBuffer =
      cudaDevice.create_buffer(sizeof(int));
