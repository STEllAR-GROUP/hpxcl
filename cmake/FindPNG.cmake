...
if(ZLIB_FOUND)
  ...
  set(PNG_SEARCH_DIRS
      PATHS /usr/local/include/libpng             # OpenBSD
            "[HKEY_LOCAL_MACHINE\\SOFTWARE\\GnuWin32\\Libng;InstallPath]"				# Windows x86
            "[HKEY_LOCAL_MACHINE\\SOFTWARE\\Wow6432Node\\GnuWin32\\LibPng;InstallPath]" # Windows x64
            "$ENV{PROGRAMFILES}/libpng"
            "$ENV{ProgramW6432}/libpng"
      )
  ...
  if(NOT PNG_LIBRARY)
    find_library(PNG_LIBRARY_RELEASE NAMES ${PNG_NAMES} ${PNG_SEARCH_DIRS} PATH_SUFFIXES lib)
    find_library(PNG_LIBRARY_DEBUG NAMES ${PNG_NAMES_DEBUG} ${PNG_SEARCH_DIRS} PATH_SUFFIXES lib)
